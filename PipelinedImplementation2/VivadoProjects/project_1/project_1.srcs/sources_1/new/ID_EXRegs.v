...
module ID_EXRegs
                (
                    ...
                    input wire [5-1:0]CI25_21_Regs_from_ID,
                    ...
                    output wire [5-1:0]Rs_ID_EX, 
                    output wire [5-1:0]Rt_ID_EX, 
                    output wire [5-1:0]Rd_ID_EX
                    

                );


reg [5-1:0]CI25_21_Regs_to_EX;
    ...
    begin
        if(rst == 1)
            ...
            begin
                ...
                CI25_21_Regs_to_EX <= CI25_21_Regs_from_ID;
...
assign Rs_ID_EX = CI25_21_Regs_to_EX;
assign Rt_ID_EX = CI20_16_Regs_to_EX;
assign Rd_ID_EX = CI15_11_Regs_to_EX;
